...
// Returns the prepared MultimodalInput and true if valid, or nil and false if invalid
func (v *ImageValidator) ValidateAndPrepare(imageBase64 string, chunkIndex int) (*indexer.MultimodalInput, bool) {
	...
	return &indexer.MultimodalInput{
		Type:        "image",
		ImageBase64: cleanBase64,
		ImageFormat: formatLower,
